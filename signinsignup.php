...
<body>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>New here ?</h3>
                    <p>
                        Sign up to know more about Numerology, Matchmaking and Daily Horoscope 
                    </p>
            ...
            <div class="panel right-panel">
                <div class="content">
                    <h3>One of us ?</h3>
                    <p>
                        Login to know more about your Daily Horoscope
                    </p>
    ...
    if ($gender='male')
    {
    mysqli_query($conn,"insert into male values('$uname','$pass', '$email','$gender')");
    }
    else if ($gender='female')
    {
    mysqli_query($conn,"insert into female values('$uname','$pass', '$email','$gender' )");
    }
